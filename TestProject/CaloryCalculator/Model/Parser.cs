...
namespace CaloryCalculator
{
    ...
    {
        //TODO 
        //1. добавить в аккаунт поля "пол" и "цель" 
        //2. допилить функционал к классу Calculator, чтоб вычислять калории на основании цели и пола
        //3. допилить фичу с корректировкой захомяченных продуктов
        //4. пофиксить баг окна обновления в результате которого в окне не отображается инфа
        //5. сделать класс обработчика для вывода информации на основании калорий и бжу
